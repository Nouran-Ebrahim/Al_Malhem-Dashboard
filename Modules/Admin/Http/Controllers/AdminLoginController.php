...
class AdminLoginController extends Controller
{
    ...
    public function login(Request $request){
        $this->validate($request,[
            'email' => 'exists:admins,email|required|email',
            'password' => 'required|min:6',
        ], [
            'email.required' => 'البريد الالكتروني مطلوب',
            'email.email' => 'يجب أن يكون  البريد الالكتروني  صحيح البُنية.',
            'email.exists' => 'هذا المستخدم غير موجود تأكد من البريد الاكتروني او كلمة المرور',
