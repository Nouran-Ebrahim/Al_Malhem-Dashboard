                        ...
                        <div class="modal-body px-5 pb-5">
                            ...
                            <form id="addRoleForm" class="row" onsubmit="return false">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-flush-spacing">
                                            ...
                                            <tr>
                                                <td class="text-nowrap fw-bolder">{{ __('permissions.' . $key)}}</td>
                                                <td>
                                                    <div class="d-flex">
                                                        @foreach($permissions as $permission)
                                                        <div class="form-check me-3 me-lg-5">
                                                            <input class="form-check-input" name="permission" value="{{$permission['id']}}" type="checkbox" />
                                                            <label class="form-check-label" for="userManagementRead"> {{__('permissions.' . $permission['display'])}} </label>
                                                        </div>
                                                        @endforeach
                                                    </div>
                                                </td>
                                ...
                                <div class="col-12 text-center mt-2">
                                    <button type="submit" class="btn btn-primary me-1 data-submit">تعديل</button>
