...
@section('js')
    ...
    @if (session('updated'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم تعديل  قسم التطوع بنجاح',
                icon: 'success',
                customClass: {
    ...
    @if (session('created'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء  قسم التطوع بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
    ...
    <script>
        $(function() {
            ...
            var ajaxRequest = "volunteeringTypes?";
                                ...
                                return (
                                    ...
                                    @can('Delete-volunteering_type')
                                        ...
                                        feather.icons['trash-2'].toSvg({
                                            ...
                                            'حذف</a>'
                                    @endcan
                                    @can('Edit-volunteering_type')
                                        +
                                        '<a href="volunteeringTypes/activate/' + data +
                                            '/" class="dropdown-item ">' +
                        ...
                        @can('Create-volunteering_type')

                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    window.location.href = './volunteeringTypes/create';
                                },
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: window.location.origin + "/admin/volunteeringTypes/" + id,
                            type: 'POST',
                            data: {
                                "id": id,
                                "_method": "DELETE",
