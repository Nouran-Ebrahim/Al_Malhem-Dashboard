    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">تعديل البيانات الخاصه بالتطوع {{ $volunteering['title'] }}</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ url('admin/volunteering/' . $volunteering->id) }}"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    {{-- <input type="hidden" name="client_id" value="{{ $volunteering->client_id }}"> --}}
                                    <input disabled type="text" class="form-control name" name="clientName" 
                                            value="{{ $volunteering->client->name }}" />
                                       
                                    {{-- <select class="select2 form-select client" name="client_id" id="default-select">
                                        @foreach ($viewModel->clients() as $client)
                                            <option @if ($client->id == $volunteering->client_id) selected @endif
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" id="fname-icon" class="form-control phone" name="phone"
                                            placeholder="phone number" value="{{ $volunteering->phone }}" />
                                        @error('phone')
                                            <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check">
                                        <input value="female" class="form-check-input" type="radio" name="gender"
                                            id="flexRadioDefault1" @if ($volunteering->gender == 'female') checked @endif>
                                    ...
                                    <div class="form-check">
                                        <input value="male" class="form-check-input" type="radio" name="gender"
                                            id="flexRadioDefault2" @if ($volunteering->gender == 'male') checked @endif>
                        ...
                        <div class="col-sm-9 offset-sm-3">
                            <div class="mb-1">
                                <div class="form-check">
                                    <input type="checkbox" value="1" @if ($volunteering->is_active == 1) checked @endif
