    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">تعديل البيانات الخاصه بالقسم {{ $serviceType['title'] }}</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{ url('admin/serviceType/' . $serviceType->id) }}" method="POST"
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="fname-icon" value="{{ $serviceType->title }}"
                                ...
                                <div class="mb-1">
                                    <div class="form-check">
                                        <input type="checkbox" value="1"
                                            @if ($serviceType->is_active == 1) checked @endif name="is_active"
