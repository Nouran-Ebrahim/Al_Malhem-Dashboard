    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"></h4>انشاء مجلس جديد</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal invoice-repeater" enctype="multipart/form-data" action="{{ url('admin/meeting/') }}"
                    method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="row d-flex align-items-end">
                                        <div class="col-md-3 col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="select form-select " name="day_name" id="default-select">
