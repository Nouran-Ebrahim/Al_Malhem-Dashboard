...
@section('content')
    ...
    <!--/ Basic table -->
        {{ $newsCategories->withQueryString()->links() }}
...
@section('js')
    ...
    @if (session('updated'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم تعديل  قسم الخبر بنجاح',
                icon: 'success',
                customClass: {
    ...
    @if (session('created'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء  قسم الخبر بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
                                ...
                                return (
                                    ...
                                    @can('Delete-news_category')
                                        ...
                                        feather.icons['trash-2'].toSvg({
                                            ...
                                            'حذف</a>'
                                    @endcan
                                    @can('Edit-news_category')
                                        +
                                        '<a href="newsCategory/activate/' + data +
                                            '/" class="dropdown-item ">' +
                        ...
                        @can('Create-news_category')

                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    window.location.href = './newsCategory/create';
                                },
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: window.location.origin + "/admin/newsCategory/" + id,
                            type: 'POST',
                            data: {
                                "id": id,
                                "_method": "DELETE",
