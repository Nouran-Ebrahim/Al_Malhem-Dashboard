                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <select class="select form-select " name="news_category_id" id="default-select">

                                            <option @if ($news->news_category_id == null) selected @endif
                                                value="{{ null }}">اختر القسم</option>
                                            @foreach ($viewModel->newsCategories() as $newsCategory)
                                                <option @if ($newsCategory->id == $news->news_category_id) selected @endif
                            ...
                            <div class="images-container  d-flex flex-row flex-wrap"
                                ...
                                @for ($j = 0; $j < count($news->images); $j++)
                                    <div class="image-container position-relative"
                                        image-id="{{ $news->images[$j]->source }}"
                                        style="width: 100px; height: 100px;margin: 2px 7px;margin-top:10px"
                                        image-index="{{ $news->images[$j]->id }}" image-name="">
                                        <img style="width: 100%; height: 100%"
                                            src="{{ asset($news->images[$j]->source) }}">
                                        <span class="position-absolute text-center"
                                            ...
                                            onclick="removeImage(this,{{ $news->images[$j]->id }},'هل ترغب فى تاكيد عملية الحذف')">X</span>
                                    </div>
                                @endfor
                                ...
                                <div class="mb-1">
                                    <div class="form-check">
                                        <input type="checkbox" value="1"
                                            @if ($news->is_active == 1) checked @endif name="is_active"
