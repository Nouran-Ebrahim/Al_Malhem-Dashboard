        ...
        <div class="card">
            <div
                class="
                    ...
                    ">
                <div>
                    <h4 class="card-title mb-25"> فلترة الاخبار
                    </h4>
                    ...
                    <form class="dt_adv_search">
                        <div class="row g-1 mb-md-1">
                            <div class="col-md-4">
                                ...
                                <select name="news_category_id" class="form-select" id="name522">
                                    <option selected value="{{ null }}">اختر</option>

                                    @foreach ($viewModel->newsCategories() as $newsCategory)
                                        <option @if ($newsCategory->id == @$_GET['news_category_id']) selected @endif
                                            value="{{ $newsCategory->id }}">{{ $newsCategory->title }}
                                        </option>
                                    @endforeach
...
@section('js')
    ...
    <script>
        $(function() {
            ...
            var newsCategory = url.searchParams.get("news_category_id")

            var ajaxRequest = "news?";
            var page = url.searchParams.get("page")
            if (page != null) {
                ajaxRequest += "page=" + page + '&';
            }
            if (newsCategory != null) {
                ajaxRequest += "news_category_id=" + newsCategory + "&";
            }
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return (
                                    ...
                                    @can('Edit-news')
                                        +
                                        '<a href="news/' + data + '/edit" class="item-edit">' +
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: window.location.origin + "/admin/news/" + id,
                            type: 'POST',
                            data: {
                                "id": id,
                                "_method": "DELETE",
