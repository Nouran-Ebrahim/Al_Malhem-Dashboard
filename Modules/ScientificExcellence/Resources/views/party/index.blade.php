...
@section('js')
    ...
    @if (session('updated'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم تعديل  الحفلة بنجاح',
                icon: 'success',
                customClass: {
    ...
    @if (session('created'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء  الحفلة بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
                            ...
                            render: function(data, type, full, meta) {
                                if (data === null) {
                                    return (
                                        ...
                                        `<a style="pointer-events: none; color: red;" href="${data}" download> لايوجد ملف</a>`
                                    );
                                } else {
                                    return (
                                        `<a href="${data}" download>تحميل الملف</a>`
                                    )
                                }
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: window.location.origin + "/admin/party/" + id,
                            type: 'POST',
                            data: {
                                "id": id,
                                "_method": "DELETE",
