    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"></h4>انشاء حفله جديد</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" enctype="multipart/form-data" action="{{ url('admin/party/') }}"
                    method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input  type="file" class="form-control" name="file"
                                            placeholder="ملف" value="{{ old('file') }}" />
