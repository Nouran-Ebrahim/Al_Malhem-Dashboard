    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"></h4>انشاء مناسبة جديد</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" enctype="multipart/form-data" action="{{ url('admin/occasions/') }}"
                    method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <select class="select form-select " name="occasions_category_id"
                                            ...
                                            @foreach ($viewModel->OccasionsCategories() as $occasionsCategory)
                                                <option value="{{ $occasionsCategory->id }}">{{ $occasionsCategory->title }}
                                                </option>
                                            @endforeach
