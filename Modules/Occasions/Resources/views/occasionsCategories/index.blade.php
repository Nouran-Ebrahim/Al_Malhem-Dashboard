...
@section('content')
    ...
    <!--/ Basic table -->
        {{ $occasionsCategories->withQueryString()->links() }}
...
@section('js')
    ...
    @if (session('updated'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم تعديل  قسم المناسبة بنجاح',
                icon: 'success',
                customClass: {
    ...
    @if (session('created'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء  قسم المناسبة بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
    ...
    <script>
        $(function() {
            ...
            var ajaxRequest = "occasionsCategory?";
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return (
                                    ...
                                    'حذف</a>'
                                    @endcan
                                    @can('Edit-occasions_category')
                                        +
                                        '<a href="occasionsCategory/activate/' + data +
                                            '/" class="dropdown-item ">' +
                    ...
                    buttons: [
...

                        {
                            ...
                            action: function(e, dt, node, config) {
                                ...
                                window.location.href = './occasionsCategory/create';
                            },
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: window.location.origin + "/admin/occasionsCategory/" + id,
                            type: 'POST',
                            data: {
                                "id": id,
                                "_method": "DELETE",
